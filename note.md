...
7. Добавить переменные класса (списки) для отчета, каждый экземпляр будет добавлять в них результаты своей работы. Написать метод, формирующий файл отчета по всем экземплярам
